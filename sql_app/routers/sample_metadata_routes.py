...
async def get_sample_metadata_by_sample_name(
    ...
    Returns:
        list: List of sample metadata JSON row objects from database
    """
    return fetch.sample_metadata.get_sample_metadata_by_sample_name(
...
async def get_sample_metadata_by_group_name(
    ...
    Returns:
        list: List of sample metadata JSON row objects from database
    """
    return fetch.sample_metadata.get_sample_metadata_by_group_name(
        group_name, table, db
    )
...
async def get_sample_metadata_by_time_point(
    ...
    Returns:
        list: List of sample metadata JSON row objects from database
    """
    return fetch.sample_metadata.get_sample_metadata_by_time_point(
        time_point, table, db
    )
